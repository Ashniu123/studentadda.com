...
//Functions to reset the text input field to blank in case of both modals to add and delete notes
        ...
        function col() //Assigns random color
        {
...
//Function of hide the image displaying modal
        ...
        $('#addNote').click(function () {
            var url = noTrailingSlash(window.location) + '/user/subject';
            var data = {
                "orderno": notesData[notesData.length - 1].orderno + 1,
                "subject": $('#subject1').val()
            };
            console.log("Sending Add Subject Data", data);
            $.ajax({
                url: url,
                method: "POST",
                data: data,
        ...
        $('#delNote').click(function () {
            ...
            console.log("Sending Delete Subject Data", data);
            $.ajax({
                url: url,
                method: "DELETE",
                data: data,
